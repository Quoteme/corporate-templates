...
#let study-evaluation(
  ...
  text(size: 8.5pt, tracking: 0.16em, fill: muted)[CLINICAL INVESTIGATION REPORT]
  v(10pt)
  ...
  v(8pt)
  text(size: 11pt, fill: muted)[Prepared for #company-name]
  if recipients.len() > 0 {
    v(10pt)
  ...
  grid(
    ...
    metadata-row("Document Type", [Study evaluation]),
    metadata-row("Status", [Draft]),
    metadata-row("Audience", [Clinical and regulatory stakeholders]),
